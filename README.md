...
[![npm](https://img.shields.io/npm/v/@browser-automation-hub%2Fservicenow-browser-automation.svg)](https://www.npmjs.com/package/@browser-automation-hub/servicenow-browser-automation)
...
This project gives you a **complete browser automation scaffold** for ServiceNow using Puppeteer (self-hosted, open source) or [Anchor Browser](https://anchorbrowser.io) (cloud, managed, production-ready).
...
*Built with ❤️ for developers who need to automate ServiceNow without wrestling with its API limitations. Powered by [Anchor Browser](https://anchorbrowser.io) for cloud-scale automation.*
