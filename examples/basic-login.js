/**
 * basic-login.js — Basic login example for ServiceNow
...
async function main() {
  ...
  try {
    log('Starting ServiceNow automation (Open Source mode)');
    ...
    const result = await login_servicenow(page, {
    ...
    // const data = await create_incident(page, {});
    // log('Data:', data);
