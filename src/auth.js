/**
 * auth.js — Authentication handler for ServiceNow
 * Supports: SSO (Okta / Azure AD / SAML), MFA (Okta / Duo / Azure MFA)
 *
...
const BASE_URL = process.env.SERVICENOW_URL || 'https://your-instance.service-now.com/login.do';
...
async function performLogin(page) {
  if (!USERNAME || !PASSWORD) {
    throw new Error(`Set SERVICENOW_USERNAME and SERVICENOW_PASSWORD in .env`);
  }

  console.log('Logging in to ServiceNow...');
  await page.goto(BASE_URL, { waitUntil: 'networkidle2' });
